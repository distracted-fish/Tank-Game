...
import main.java.menus.EndGamePanel;
import main.java.menus.StartMenuPanel;
...
public class Launcher {
    ...
    public void setFrame(String type){
        ...
        ImageIcon img = new ImageIcon("/FishIcon.png");
